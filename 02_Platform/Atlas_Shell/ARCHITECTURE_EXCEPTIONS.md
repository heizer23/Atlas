...
This file formally records accepted deviations from Atlas architectural rules for the `02_Platform/Atlas_Shell` component.
...
CANONICAL_SOURCE: 02_Platform/Atlas_Shell/ARCHITECTURE_EXCEPTIONS.md
```
