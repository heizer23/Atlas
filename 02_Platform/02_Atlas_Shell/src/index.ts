/**
 * File: 02_Platform/02_Atlas_Shell/src/index.ts
 ...
 *   '@atlas/shell': path.resolve(__dirname, '../../02_Platform/02_Atlas_Shell/src/index.ts')
 *
 * And in their tsconfig.json paths:
 *   "@atlas/shell": ["../../02_Platform/02_Atlas_Shell/src/index.ts"]
 */
